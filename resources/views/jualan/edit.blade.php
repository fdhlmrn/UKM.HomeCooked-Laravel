        ...
        <div class="col-md-10">
          <form class="form-horizontal" action="{{ action('FoodsController@update', $food->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  <input class="form-control" type="text" name="nama_makanan" placeholder="Nama Makanan" value="{{ $food->nama_makanan}}">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  <input class="form-control" type="text" name="saiz_hidangan" placeholder="Saiz Hidangan" value="{{ $food->saiz_hidangan}}">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-8">
                <div class="form-group">
                  <input class="form-control" type="text" name="harga" placeholder="Harga Hidangan" value="{{ $food->harga}}">
                </div>
              </div>
            </div>  
            <div class="form-group">
